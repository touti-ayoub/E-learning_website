...
import { Course, CourseModule, Lesson, CourseProgress, LearningObjective, PrerequisiteSkill } from '../models/course.model';
...
export class CourseService {
  ...
  createCourse(course: Course, instructorId: number): Observable<Course> {
    return this.http.post<Course>(`${this.apiUrl}/instructor/${instructorId}`, course);
  }
  ...
  addModule(courseId: number, module: CourseModule): Observable<CourseModule> {
    return this.http.post<CourseModule>(`${this.apiUrl}/${courseId}/modules`, module);
  }

  /**
   * Update an existing module in a course
   */
  updateModule(courseId: number, moduleId: number, module: CourseModule): Observable<CourseModule> {
    return this.http.put<CourseModule>(`${this.apiUrl}/${courseId}/modules/${moduleId}`, module);
  }
  ...
  getLessons(courseId: number, moduleId: number): Observable<Lesson[]> {
    return this.http.get<Lesson[]>(`${this.apiUrl}/${courseId}/modules/${moduleId}/lessons`);
  }

  /**
   * Add a new lesson to a module in a course
   */
  addLesson(courseId: number, moduleId: number, lesson: Lesson): Observable<Lesson> {
    return this.http.post<Lesson>(`${this.apiUrl}/${courseId}/modules/${moduleId}/lessons`, lesson);
  }

  /**
   * Update an existing lesson in a module in a course
   */
  updateLesson(courseId: number, moduleId: number, lessonId: number, lesson: Lesson): Observable<Lesson> {
    return this.http.put<Lesson>(`${this.apiUrl}/${courseId}/modules/${moduleId}/lessons/${lessonId}`, lesson);
  }
  ...
  deleteLesson(courseId: number, moduleId: number, lessonId: number): Observable<void> {
    return this.http.delete<void>(`${this.apiUrl}/${courseId}/modules/${moduleId}/lessons/${lessonId}`);
  }
   ...
   */
  getUserProgress(courseId: number, userId: number): Observable<CourseProgress> {
    return this.http.get<CourseProgress>(`${this.apiUrl}/${courseId}/progress/${userId}`);
  }

  /**
   * Update user progress for a course
   */
  updateUserProgress(courseId: number, userId: number, progress: CourseProgress): Observable<CourseProgress> {
    return this.http.put<CourseProgress>(`${this.apiUrl}/${courseId}/progress/${userId}`, progress);
  }
  ...
  getLearningObjectives(courseId: number): Observable<LearningObjective[]> {
    return this.http.get<LearningObjective[]>(`${this.apiUrl}/${courseId}/objectives`);
  }

  /**
   * Update learning objectives for a course
   */
  updateLearningObjectives(courseId: number, objectives: LearningObjective[]): Observable<LearningObjective[]> {
    return this.http.put<LearningObjective[]>(`${this.apiUrl}/${courseId}/objectives`, objectives);
  }
  ...
  getPrerequisites(courseId: number): Observable<PrerequisiteSkill[]> {
    return this.http.get<PrerequisiteSkill[]>(`${this.apiUrl}/${courseId}/prerequisites`);
  }

  /**
   * Update prerequisites for a course
   */
  updatePrerequisites(courseId: number, prerequisites: PrerequisiteSkill[]): Observable<PrerequisiteSkill[]> {
    return this.http.put<PrerequisiteSkill[]>(`${this.apiUrl}/${courseId}/prerequisites`, prerequisites);
  }
  ...
  generateAutomatedCourse(courseData: any): Observable<Course> {
    return this.http.post<Course>(`${this.apiUrl}/automated`, courseData);
  }
  ...
  getRecentCourses(limit: number): Observable<Course[]> {
    return this.http.get<Course[]>(`${this.apiUrl}/recent`, { params: { limit: limit.toString() } });
  }

  getTopPerformingCourses(limit: number): Observable<Course[]> {
    return this.http.get<Course[]>(`${this.apiUrl}/top-performing`, { params: { limit: limit.toString() } });
  }
} 